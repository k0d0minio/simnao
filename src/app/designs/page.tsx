...
/* ------------------------------------------------------------------ */
/*  Index — a quiet "control room" for Simão to compare the landing-  */
/*  page directions. Kept here at /designs as a hidden archive now     */
/*  that design 09 (Overprint) is the live home page. Intentionally    */
/*  neutral so the concepts speak for themselves.                      */
/* ------------------------------------------------------------------ */
...
const designs = [
  ...
  },
  {
    ...
    no: "09",
    name: "Overprint",
    tagline: "Silkscreen · pulled out of register — selected",
    blurb:
      "A hand-pulled print. Two spot inks laid down out of register, halftone edges, crop and registration marks in the margins, edition stamps. The mis-registration is the yes/no printed twice, never landing in the same place. This is the live home page.",
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mt-5 max-w-xl text-neutral-400">
            ...
            worked-over notebook, and the misregistered print.{" "}
            <span className="text-neutral-200">
              Design 09 — Overprint — is the selected direction and now lives at
              the home page.
            </span>{" "}
            The rest are archived here.
          </p>
        </motion.header>
